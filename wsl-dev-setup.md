...
$src = Get-ChildItem "$env:LOCALAPPDATA\Microsoft\WinGet\Packages" `
  -Recurse -Filter "npiperelay.exe" | Where-Object { $_.Length -gt 0 } | Select-Object -ExpandProperty FullName -First 1
